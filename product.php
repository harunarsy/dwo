                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Top 10 Produk yang paling banyak Terjual</h6>
                                </div>
                                <!-- Card Body -->
                                    ...
                                    <div class="chart-area-store">
                                        ...
                                        <?php
                                            ...
                                            $kategori = mysqli_query($mysqli,"SELECT DISTINCT(Name), COUNT(sf.ProductID) as total 
                                                    FROM salesfact sf JOIN product p ON p.ProductID = sf.ProductID
                                            ...
                                            ?>
                                            <!-- $kategori = mysqli_query($mysqli,"SELECT DISTINCT(Name), COUNT(sf.ProductID) as total 
                                                    FROM salesfact sf JOIN shipmethod s ON s.ShipMethodID = sf.ShipMethodID
