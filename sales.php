...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">ADVENTUREWORKS 2022</div>
            </a>
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(SalesPersonID) as total_salesperson from salesperson";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['total_salesperson'],0,".",".");
                                                        }
                                                ?>  
                                                </div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Penjualan Per Unit</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT COUNT(unit_sold) as total_salesorder from salesfact";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['total_salesorder'],0,".",".");
                                                 }
                                            ?>
                                            </div>
                                        </div>
                        ...
                        <!-- <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Jumlah Pembelian Tahun 2004
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sql = "SELECT COUNT(DISTINCT(s.SalesOrderID)) salesorder FROM salesfact s JOIN time t ON s.DateID=t.DateID WHERE t.year=2002";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary"> Total Penjualan berdasarkan SalesPerson </h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <?php
                                            ...
                                            $lamapinjam = mysqli_query($mysqli,"SELECT DISTINCT(SalesPersonID), COUNT(SalesOrderID) as SalesOrderID FROM salesfact WHERE SalesPersonID IS NOT NULL AND SalesPersonID > 0 GROUP BY SalesPersonID ORDER BY SalesOrderID DESC");
                                            while($row = mysqli_fetch_array($lamapinjam)){
                                                $jenis_lamapinjam[] = $row['SalesPersonID'];

                                                $query = mysqli_query($mysqli,"SELECT COUNT(SalesOrderID) as SalesOrderID FROM salesfact WHERE SalesPersonID IS NOT NULL AND SalesPersonID > 0 AND SalesPersonID='".$row['SalesPersonID']."'");
                                                $row = $query->fetch_array();
                                                $customer[] = $row['SalesOrderID'];
                                            };
                                            ?>
    ...
    <script type="text/javascript">
        ...
        $customer = "SELECT COUNT(sf.ShipMethodID) customer FROM salesfact sf JOIN time t ON sf.DateID=t.DateID GROUP BY t.Month ORDER BY t.completeDate";
