                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Pendapatan Tahun (2003)
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sql = "SELECT t.Year Year, sum(fp.Dollar_total) as tot_amount
                                                            FROM salesfact fp
                                                            JOIN time t ON (t.DateID = fp.DateID)
                                                            where Year='2003'";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                    ...
                                    <div class="chart-area-store">
                                        ...
                                        <?php
                                            ...
                                            while($row = mysqli_fetch_array($tahun)){
                                                ...
                                                $query = mysqli_query($mysqli,"SELECT SUM(fp.Dollar_total) as total, t.Year FROM salesfact fp JOIN time t ON fp.DateID=t.DateID WHERE Year='".$row['Year']."' GROUP BY Year");
